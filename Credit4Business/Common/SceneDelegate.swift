...
//        if UserDefaults.standard.value(forKey: "isLogin") as? Int == 1 && UserDefaults.standard.value(forKey: "isLogin") as? Int  {
        if UserDefaults.standard.value(forKey: "access") as? String != "" &&  UserDefaults.standard.value(forKey: "access") as? String != nil  {

            if UserDefaults.standard.value(forKey: "role") as? String != "" &&  UserDefaults.standard.value(forKey: "role") as? String != nil && UserDefaults.standard.value(forKey: "role") as? String == "LEADS"{
                var navigationController = UINavigationController()
                navigationController = UINavigationController(rootViewController: HomeViewController.initWithStory())
